...
import { CircleHelp, Eye, EyeOff, History, KeyRound, LockKeyhole, LogIn, ShieldCheck, Trash2, UserPlus, X } from 'lucide-react'
...
export function AccountPage() {
  ...
  return (
    <div className={styles.accountPage}>
      ...
      <NavLink className={styles.activityAccountLink} to="/activity">
        <History aria-hidden="true" size={19} />
        <span><strong>나의 활동</strong><small>추천한 곡과 받은 반응을 확인합니다.</small></span>
      </NavLink>
      {account.admin ? (
